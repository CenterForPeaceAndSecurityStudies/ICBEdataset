...
#reticulate::use_python("~/anaconda3/bin/python3.6") # never worked for me
#reticulate::use_python("~/.local/share/r-miniconda/envs/r-reticulate/bin/python3.6") #works but needed module install
...
temp_all %>% ungroup() %>% filter(crisno %in% c(1:60) )  %>% convert_to_ft() %>%
  save_as_image(path=here::here("replication_paper", "figures", "crisis_text_counts_ft1.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(61:120) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "figures", "crisis_text_counts_ft2.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(121:180) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "figures", "crisis_text_counts_ft3.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(181:240) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "figures", "crisis_text_counts_ft4.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(241:300) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "figures", "crisis_text_counts_ft5.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(301:360) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "figures", "crisis_text_counts_ft6.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(361:420) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "figures", "crisis_text_counts_ft7.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(421:500) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "figures", "crisis_text_counts_ft8.png"), zoom=1)
...
\centering{\includegraphics[ height=21cm]{"../figures/crisis_text_counts_ft1.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"../figures/crisis_text_counts_ft2.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"../figures/crisis_text_counts_ft3.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"../figures/crisis_text_counts_ft4.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"../figures/crisis_text_counts_ft5.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"../figures/crisis_text_counts_ft6.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"../figures/crisis_text_counts_ft7.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"../figures/crisis_text_counts_ft8.png"}}
\end{figure}
...
ft_cuba_recall %>% save_as_image(path=here::here("replication_paper", "figures", "ft_cuba_recall.png"), zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{../figures/ft_cuba_recall.png}}
\end{figure}
\clearpage
...
ft_crimea_recall %>% save_as_image(path=here::here("replication_paper", "figures", "ft_crimea_recall.png"), zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{../figures/ft_crimea_recall.png}}
\end{figure}
\clearpage
...
if(fromscratch){
  ...
  ft_crimea_precision_part1 %>% save_as_image(path=here::here("replication_paper", "figures", "case_study_crimea_precision_part1.png"), zoom=1) # webshot = "webshot2"
  ...
  ft_crimea_precision_part2 %>% save_as_image(path=here::here("replication_paper", "figures", "case_study_crimea_precision_part2.png"), zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{../figures/case_study_crimea_precision_part1.png}}
\end{figure}
\clearpage

\begin{figure}[H]
\centering{\includegraphics[height=21cm]{../figures/case_study_crimea_precision_part2.png}}
\end{figure}
\clearpage
...
ft_sample_precision_precision1 %>% save_as_image(path=here::here("replication_paper", "figures", "ft_sample_precision_precision1.png"), zoom=1) # 
...
ft_sample_precision_precision2 %>% save_as_image(path=here::here("replication_paper", "figures", "ft_sample_precision_precision2.png"), zoom=1) # 
...
\centering{\includegraphics[height=21cm]{"../figures/ft_sample_precision_precision1.png"}}
\end{figure}
\clearpage
...
\hphantom{em}
\begin{figure}[H]
\centering{\includegraphics[height=21cm]{"../figures/ft_sample_precision_precision2.png"}}
\end{figure}
\clearpage
...
if(fromscratch){
  p_phoenix_plot_lv0_196 <- readRDS(here::here("replication_paper", "figures", "p_phoenix_plot_lv0_196.Rds"))
...
if(fromscratch){
  p_phoenix_plot_lv0_471 <- readRDS(here::here("replication_paper", "figures", "p_phoenix_plot_lv0_471.Rds"))
...
if(fromscratch){
  p_terrier_plot_lv0_471 <- readRDS(here::here("replication_paper", "figures", "p_terrier_plot_lv0_471.Rds"))
...
if(fromscratch){
  p_icews_plot_lv0_471 <- readRDS(here::here("replication_paper", "figures", "p_icews_plot_lv0_471.Rds"))
