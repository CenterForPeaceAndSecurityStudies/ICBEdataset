...
temp_all %>% ungroup() %>% filter(crisno %in% c(1:60) )  %>% convert_to_ft() %>%
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft1.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(61:120) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft2.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(121:180) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft3.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(181:240) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft4.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(241:300) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft5.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(301:360) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft6.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(361:420) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft7.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(421:500) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft8.png", zoom=1)
...
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft1.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft2.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft3.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft4.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft5.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft6.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft7.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisis_text_counts_ft8.png"}}
\end{figure}
...
ft_cuba_recall %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/ft_cuba_recall.png", zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/ft_cuba_recall.png}}
\end{figure}
\clearpage
...
ft_crimea_recall %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/ft_crimea_recall.png", zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/ft_crimea_recall.png}}
\end{figure}
\clearpage
...
if(fromscratch){
  ...
  ft_crimea_precision_part1 %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/case_study_crimea_precision_part1.png", zoom=1) # webshot = "webshot2"
  ...
  ft_crimea_precision_part2 %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/case_study_crimea_precision_part2.png", zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/case_study_crimea_precision_part1.png}}
\end{figure}
\clearpage

\begin{figure}[H]
\centering{\includegraphics[height=21cm]{/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/case_study_crimea_precision_part2.png}}
\end{figure}
\clearpage
...
ft_sample_precision_precision1 <- temp_sample %>% 
                                  ...
                                  flextable::width( j = 4:5, width=8.0)  %>% 
                                  flextable::fontsize(size = 9, part = "all") %>%
                                  valign(j = 1:3, valign = "top", part = "body") %>%
                                  flextable::line_spacing( space = 1.0, part = "all") %>% 
                                  padding( padding = 1, part = "all") %>% 
...
ft_sample_precision_precision1 %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/ft_sample_precision_precision1.png", zoom=1) # 
...
ft_sample_precision_precision2 %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/ft_sample_precision_precision2.png", zoom=1) # 
...
\centering{\includegraphics[height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/ft_sample_precision_precision1.png"}}
\end{figure}
\clearpage
...
\hphantom{em}
\begin{figure}[H]
\centering{\includegraphics[height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/ft_sample_precision_precision2.png"}}
\end{figure}
\clearpage
...
icb_crisismaps <- function(thiscrisis=196, prune_rare=T){
    ...
    print(thiscrisis)
    save_icb_file <- paste0(here::here(), "/replication_paper/figures/p_icb_metro_plot_",thiscrisis,".Rds")
...
mids_crisismaps <- function(thiscrisis=196, prune_rare=T){
  ...
  save_mids_file <- paste0(here::here(), "/replication_paper/figures/p_mids_metro_plot_",thiscrisis,".Rds")
...
if(fromscratch){
  ...
  meta1_nyt2 <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/MetaDataBLN-NYT_1980-2018.csv", col_types=rep('c',50)  %>% paste0(collapse='')) #%>% convert_aid()
  meta2_swb <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/MetaDataBLN-SWB_1979-2019.csv", col_types=rep('c',50)  %>% paste0(collapse='')) #%>% convert_aid()
  meta_fbis <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/MetaDataFBIS_1995-2004.csv", col_types=rep('c',50)  %>% paste0(collapse='')) #%>% convert_aid()
  meta_nyt <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/MetaDataNYT_1945-2005.csv", col_types=rep('c',50)  %>% paste0(collapse='')) #%>% convert_aid()
  meta_wsj <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/MetaDataWSJ_1945-2006.csv", col_types=rep('c',50)  %>% paste0(collapse='')) #%>% convert_aid()
  
  events_nyt2 <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/PhoenixBLN-NYT_1980-2018.csv", col_types=rep('c',50)  %>% paste0(collapse='')) # %>% convert_aid() 
  events_swb <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/PhoenixBLN-SWB_1979-2019.csv", col_types=rep('c',50) %>% paste0(collapse='')) #%>% convert_aid() 
  events_fbis <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/PhoenixFBIS_1995-2004.csv", col_types=rep('c',50) %>% paste0(collapse='')) #%>% convert_aid()  
  events_nyt <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/PhoenixNYT_1945-2005.csv", col_types=rep('c',50) %>% paste0(collapse='')) #%>% convert_aid()  
  events_wsj <- read_csv("/mnt/8tb_a/rwd_github_private/ICBEdataset/git_ignore_folder/DOI-10-13012-b2idb-0647142_v3/PhoenixWSJ_1945-2006.csv", col_types=rep('c',50) %>% paste0(collapse='')) #%>% convert_aid()  
...
phoenix_barmaps <- function(thiscrisis=196, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/figures/p_phoenix_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/figures/p_phoenix_plot_lv0_",thiscrisis,".Rds")
...
terrier_barmaps <- function(thiscrisis=471, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/figures/p_terrier_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/figures/p_terrier_plot_lv0_",thiscrisis,".Rds")
...
icews_barmaps <- function(thiscrisis=471, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/figures/p_icews_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/figures/p_icews_plot_lv0_",thiscrisis,".Rds")
...
## Dyadic ICB
save_file=paste0(here::here(), '/replication_paper/figures/p_icb_metro_plot_196.Rds')
...
## MIDs
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/figures/p_mids_metro_plot_196.Rds') 
p_metro_plot <- readRDS(save_file)
actor_colors <- p_metro_plot$actor_colors
...
#ICBe  196
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/figures/p_phoenix_plot_penta_196.Rds')
...
if(fromscratch){
  p_phoenix_plot_lv0_196 <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/p_phoenix_plot_lv0_196.Rds")
...
## MIDs
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/figures/p_mids_metro_plot_471.Rds') 
p_metro_plot <- readRDS(save_file)
actor_colors <- p_metro_plot$actor_colors
subtitle="Dyadic Militarized Interstate Disputes (MIDs)"
caption=paste0("Source: CrisisEvents.org (Douglass et al. 2021)
...
#ICBe  196
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/figures/p_phoenix_plot_penta_471.Rds')
subtitle="Phoenix Dyadic Events"
caption=paste0("Data: Cline Center Historical Phoenix Event Data (Althaus et al. 2017)
             ", p_metro_plot$labels$caption) #tag original to bottom
...
save_file=paste0(here::here(), '/replication_paper/figures/p_terrier_plot_penta_471.Rds')
...
save_file=paste0(here::here(), '/replication_paper/figures/p_icews_plot_penta_471.Rds')
...
if(fromscratch){
  p_phoenix_plot_lv0_471 <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/p_phoenix_plot_lv0_471.Rds")
...
if(fromscratch){
  p_terrier_plot_lv0_471 <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/p_terrier_plot_lv0_471.Rds")
...
if(fromscratch){
  p_icews_plot_lv0_471 <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/p_icews_plot_lv0_471.Rds")
