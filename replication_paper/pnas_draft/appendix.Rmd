...
temp_all %>% ungroup() %>% filter(crisno %in% c(1:60) )  %>% convert_to_ft() %>%
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft1.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(61:120) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft2.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(121:180) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft3.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(181:240) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft4.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(241:300) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft5.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(301:360) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft6.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(361:420) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft7.png", zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(421:500) ) %>% convert_to_ft()  %>% 
  save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft8.png", zoom=1)
...
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft1.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft2.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft3.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft4.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft5.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft6.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft7.png"}}
\end{figure}

\begin{figure}[H]
\centering{\includegraphics[ height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/crisis_text_counts_ft8.png"}}
\end{figure}
...
```{r python load, echo=F, results='hide', message=F, warning=F, eval=T , cache=F}
...
if(fromscratch){
  raterconfidence <- icb_long_clean %>% filter(email_id %>% str_detect('expert') & varname_normalized=='raterconfidence' ) %>%
                     dplyr::select(email_id, crisno, sentence_number_int_aligned, raterconfidence=value) %>% distinct()
  ...
  ggplot2::ggsave(file=paste0(here::here(), '/replication_paper/figures/p_percent_chose_tag_by_confidence.png'), 
...
\centering{\includegraphics[width=15cm]{../figures/p_percent_chose_tag_by_confidence.png}}
\end{figure}
...
replace_emoticons_cuba <- function(x){
  x %>% str_replace_all('\U0001f1e8\U0001f1fa',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q241.png) ") %>%
        #https://emojiterra.com/flag-for-united-states/
        str_replace_all('\U0001f1fa\U0001f1f8',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q30.png) ") %>%
        #https://emojiterra.com/flag-for-russia/
        str_replace_all('\U0001f1f7\U0001f1fa',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q15180.png) ") %>% 
        #Turkey
        str_replace_all('\U0001f1f9\U0001f1f7',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q43.png) ") %>% 
        #U.N.
        str_replace_all('\U0001f1fa\U0001f1f3',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q1065.png) ")
}
...
ft_cuba_recall %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/ft_cuba_recall.png", zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/ft_cuba_recall.png}}
\end{figure}
\clearpage
...
replace_emoticons_crimea <- function(x){
      x %>%
            ...
            str_replace_all('\U0001f1fa\U0001f1f8',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q30.png) ") %>%
            #https://emojiterra.com/flag-for-russia/
            str_replace_all('\U0001f1f7\U0001f1fa',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q159.png) ") %>% 
            #Ukraine
            str_replace_all('\U0001f1fA\U0001f1e6',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q212.png) ") %>% 
            #Crimea
            str_replace_all('Crimea',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q15966495.png) ") %>%
            #EU
            str_replace_all('\U0001f1EA\U0001f1FA',  " ![](/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_data/in/flags_small//Q458.png) ")
}
...
ft_crimea_recall %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/ft_crimea_recall.png", zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/ft_crimea_recall.png}}
\end{figure}
\clearpage
...
if(fromscratch){
  ...
  ft_crimea_precision_part1 %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/case_study_crimea_precision_part1.png", zoom=1) # webshot = "webshot2"
  ...
  ft_crimea_precision_part2 %>% save_as_image(path="/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/case_study_crimea_precision_part2.png", zoom=1) # webshot = "webshot2"
...
\centering{\includegraphics[height=21cm]{/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/case_study_crimea_precision_part1.png}}
\end{figure}
\clearpage

\begin{figure}[H]
\centering{\includegraphics[height=21cm]{/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/case_study_crimea_precision_part2.png}}
\end{figure}
\clearpage
...
\hphantom{em}
\begin{figure}[H]
\caption{ Stratified Sentence Examples  \label{fig:case_study_cuban_precision}}
\centering{\includegraphics[height=21cm]{"/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/pnas_draft/ft_sample_precision_precision.png"}}
\end{figure}
\clearpage
...
icb_crisismaps <- function(thiscrisis=196, prune_rare=T){
    ...
    print(thiscrisis)
    save_icb_file <- paste0(here::here(), "/replication_paper/figures/crisismaps/p_icb_metro_plot_",thiscrisis,".Rds")
...
c(196, 471) %>% sapply(FUN=function(x) icb_crisismaps(x))
...
mids_crisismaps <- function(thiscrisis=196, prune_rare=T){
  ...
  save_mids_file <- paste0(here::here(), "/replication_paper/figures/crisismaps/p_mids_metro_plot_",thiscrisis,".Rds")
...
if(fromscratch){
  ...
  phoenix_clean %>% arrow::write_parquet(here::here("replication_paper", "data", "ignore", "phoenix_clean.parquet") )
...
phoenix_barmaps <- function(thiscrisis=196, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/figures/crisismaps/p_phoenix_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/figures/crisismaps/p_phoenix_plot_lv0_",thiscrisis,".Rds")
...
fromscratch=F
if(fromscratch){
  phoenix_clean <- arrow::read_parquet(here::here("replication_paper", "data", "ignore", "phoenix_clean.parquet") ) 
...
if(terrier_fromscratch){
    ...
    terrier_clean_temp  %>%
      arrow::write_parquet(here::here("replication_paper", "data", "ignore", "terrier_clean.parquet") )
}
...
terrier_barmaps <- function(thiscrisis=471, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/figures/crisismaps/p_terrier_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/figures/crisismaps/p_terrier_plot_lv0_",thiscrisis,".Rds")
...
if(fromscratch){
  ...
  terrier_clean <-  arrow::read_parquet( here::here("replication_paper", "data", "ignore", "terrier_clean.parquet")) #203mb
...
if(fromscratch){
  ...
  icews_clean <- icews %>% 
    ...
    icews_clean %>% arrow::write_parquet(here::here("replication_paper", "data", "ignore", "icews_clean.parquet") )
...
icews_barmaps <- function(thiscrisis=471, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/figures/crisismaps/p_icews_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/figures/crisismaps/p_icews_plot_lv0_",thiscrisis,".Rds")
    ...
    icews_clean_subset_top10_day <- icews_clean_subset_top10_day %>%
                                    ...
                                    mutate(dyad_markdown = dyad_markdown %>% str_replace_all("(tertiary role code)","")) %>%
                                    mutate(dyad_markdown = dyad_markdown %>% str_replace_all("International Committee of the Red Cross","Red Cross"))
    icews_clean_subset_top10_day %>% write_tsv("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/data/out/icews_clean_471_lowest.tsv")
...
if(fromscratch){
  #done
  #install.packages("arrow")
  icews_clean <-  arrow::read_parquet(here::here("replication_paper", "data", "ignore", "icews_clean.parquet") )
...
## Dyadic ICB
save_file=paste0(here::here(), '/replication_paper/figures/crisismaps/p_icb_metro_plot_196.Rds')
...
## MIDs
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/figures/crisismaps/p_mids_metro_plot_196.Rds') 
p_metro_plot <- readRDS(save_file)
actor_colors <- p_metro_plot$actor_colors
...
#ICBe  196
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/figures/crisismaps/p_phoenix_plot_penta_196.Rds')
...
save_plot(file=paste0(here::here(), '/replication_paper/figures/p_196_combined.png'),
...
\begin{sideways}%[htbp]
\centering{\includegraphics[width=21cm]{../figures/p_196_combined.png}}
\end{sideways}
\clearpage
...
if(fromscratch){
  p_phoenix_plot_lv0_196 <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisismaps/p_phoenix_plot_lv0_196.Rds")
  save_plot(file=paste0(here::here(), '/replication_paper/figures/p_phoenix_plot_lv0_196.png'),
...
\centering{\includegraphics[width=21cm]{../figures/p_phoenix_plot_lv0_196.png}}
\end{sidewaysfigure}
\clearpage
...
## MIDs
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/figures/crisismaps/p_mids_metro_plot_471.Rds') 
p_metro_plot <- readRDS(save_file)
actor_colors <- p_metro_plot$actor_colors
subtitle="Dyadic Militarized Interstate Disputes (MIDs)"
caption=paste0("Source: CrisisEvents.org (Douglass et al. 2021)
...
#ICBe  196
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/figures/crisismaps/p_phoenix_plot_penta_471.Rds')
subtitle="Phoenix Dyadic Events"
caption=paste0("Data: Cline Center Historical Phoenix Event Data (Althaus et al. 2017)
             ", p_metro_plot$labels$caption) #tag original to bottom
...
save_file=paste0(here::here(), '/replication_paper/figures/crisismaps/p_terrier_plot_penta_471.Rds')
...
save_file=paste0(here::here(), '/replication_paper/figures/crisismaps/p_icews_plot_penta_471.Rds')
...
save_plot(file=paste0(here::here(), '/replication_paper/figures/p_471_combined.png'),
...
\centering{\includegraphics[width=21cm]{../figures/p_471_combined.png}}
\end{sidewaysfigure}
\clearpage
...
if(fromscratch){
  p_phoenix_plot_lv0_471 <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisismaps/p_phoenix_plot_lv0_471.Rds")
  save_plot(file=paste0(here::here(), '/replication_paper/figures/p_phoenix_plot_lv0_471.png'),
...
\centering{\includegraphics[width=21cm]{../figures/p_phoenix_plot_lv0_471.png}}
\end{sidewaysfigure}
\clearpage
...
if(fromscratch){
  p_terrier_plot_lv0_471 <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisismaps/p_terrier_plot_lv0_471.Rds")
  save_plot(file=paste0(here::here(), '/replication_paper/figures/p_terrier_plot_lv0_471.png'),
...
\centering{\includegraphics[width=21cm]{../figures/p_terrier_plot_lv0_471.png}}
\end{sidewaysfigure}
\clearpage
...
if(fromscratch){
  p_icews_plot_lv0_471 <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_paper/figures/crisismaps/p_icews_plot_lv0_471.Rds")
  save_plot(file=paste0(here::here(), '/replication_paper/figures/p_icews_plot_lv0_471.png'),
...
\centering{\includegraphics[width=21cm]{../figures/p_icews_plot_lv0_471.png}}
\end{sidewaysfigure}
\clearpage
