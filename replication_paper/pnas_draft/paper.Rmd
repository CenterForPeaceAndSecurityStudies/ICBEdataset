...
ggsave(file=paste0(here::here(), '/replication_paper/pnas_draft/p_recall.png'),
       plot = p_recall ,
       width=5, height=3.0)
...
tiger2 <- image_read(paste0(here::here(), '/replication_paper/pnas_draft/p_recall.png'))
...
p_196_icbe <- icbe_crisismaps(thiscrisis=196) #readRDS(file=paste0(here::here(), '/replication_paper/pnas_draft/crisismaps/p_metro_plot_471.Rds')) +
    labs(
      #title = plot_title ,
      #subtitle = subtitle ,
      caption = NULL
...
p_471_icbe <- icbe_crisismaps(thiscrisis=471) #readRDS(file=paste0(here::here(), '/replication_paper/pnas_draft/crisismaps/p_metro_plot_471.Rds')) +
    labs(
      #title = plot_title ,
      #subtitle = subtitle ,
      caption = NULL
...
ratio=1.5
height=18
save_plot(file=paste0(here::here(), '/replication_paper/pnas_draft/p_precision_combined.png'),
...
\centering{\includegraphics[width=24cm]{./p_precision_combined.png}}
\end{sidewaysfigure}
\clearpage
\twocolumn
...
ggsave(file=paste0(here::here(), '/replication_paper/pnas_draft/p_semantic_embeddings.png'), plot = p_semantic_embeddings, width=12, height=8)
...
ggsave(file=paste0(here::here(), '/replication_paper/pnas_draft/p_semantic_embeddings_dendro.png'), plot = p_combined, width=12, height=10)
...
save_plot(file=paste0(here::here(),
                      '/replication_paper/pnas_draft/p_precision_icews.png'),
