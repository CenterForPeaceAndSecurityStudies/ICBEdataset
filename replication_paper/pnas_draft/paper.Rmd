...
ft_cuba_precision %>% save_as_image(path=here::here("replication_paper","pnas_draft","case_study_cuban_precision.png"), zoom=1) # webshot = "webshot2"
temp <- NULL
...
\centering{\includegraphics[ height=22cm]{"./case_study_cuban_precision.png"}}
\end{figure}
\clearpage
\twocolumn
...
ft   %>% 
    #flextable::flextable_to_rmd()
    save_as_image(path=here::here("replication_paper", "pnas_draft", "case_study_cuban_recall.png"), zoom=1, webshot = "webshot2") # webshot = "webshot2"
...
ft   %>% 
    #flextable::flextable_to_rmd()
    save_as_image(path=here::here("replication_paper", "pnas_draft", "case_study_crimea_recall.png"),
...
ft   %>% 
    #flextable::flextable_to_rmd()
    save_as_image(path=here::here("replication_paper", "pnas_draft", "recall_cuban_and_crimea.png"), zoom=1, webshot = "webshot2") # webshot = "webshot2"
...
tiger <- image_read(here::here("replication_paper", "pnas_draft", "recall_cuban_and_crimea.png"))
...
image_write(combined, here::here("replication_paper", "pnas_draft", "recall_cuban_and_crimea_andcounts.png"))
