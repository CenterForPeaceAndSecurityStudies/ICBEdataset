...
lit_review_alt <- lit_review_pull %>% 
                  ...
                  mutate(Concept = Concept %>% stringr::str_replace(stringr::fixed("[NA]"),"") ) %>%
...
litreview_ft_political_analysis <- lit_review_alt %>%
      ...
      vline( i = 1, j = c(2,8), border = NULL, part = "header") %>%
      vline( i = 1:(n), j = 1, border = NULL, part = "body")  %>%
      vline( i = 1:(n), j = c(2,8), border = NULL, part = "body")  %>%

      flextable::width( j = 2, width=3.1) %>% # change width for inline citations for politicalanalysis (4 works, might have extra room)
      flextable::width( j = (3):k, width=0.25) %>%
      ...
      ftExtra::colformat_md(j = 2, part="body")    #Make sure this goes last or it'll get overwritten by the colformat above
