...
litreview_ft_political_analysis <- lit_review_alt %>%
      ...
      flextable::width( j = 3, width=3.3) %>% # change width for inline citations for politicalanalysis (4 works, might have extra room)
...
Data Availability Statement {#format .unnumbered}
========================================
...
Conflicts of Interests {#format .unnumbered}
========================================
