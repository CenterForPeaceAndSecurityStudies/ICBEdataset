...
ft_cuba_precision %>% save_as_image(path=here::here("replication_paper","political_analysis_draft","case_study_cuban_precision.png"), zoom=1) # webshot = "webshot2"
temp <- NULL
...
litreview_ft_political_analysis <- lit_review_alt %>%
      flextable::as_flextable() %>%
...
#litreview_ft_political_analysis


#litreview_ft_political_analysis  %>% saveRDS(paste0(here::here(), '/replication_paper/tables/litreview_ft_political_analysis.Rds'))
litreview_ft_political_analysis %>% 
...
# litreview_ft_political_analysis %>% 
#     #flextable::flextable_to_rmd()
#     save_as_image(path=here::here("replication_paper", "political_analysis_draft", "litreview_ft.png"), zoom=1, webshot = "webshot2") # webshot = "webshot2"
...
ft   %>% 
    #flextable::flextable_to_rmd()
    save_as_image(path=here::here("replication_paper", "political_analysis_draft", "case_study_cuban_recall.png"), zoom=1, webshot = "webshot2") # webshot = "webshot2"
...
ft   %>% 
    #flextable::flextable_to_rmd()
    save_as_image(path=here::here("replication_paper", "political_analysis_draft", "case_study_crimea_recall.png"),
...
ft   %>% 
    #flextable::flextable_to_rmd()
    save_as_image(path=here::here("replication_paper", "political_analysis_draft", "recall_cuban_and_crimea.png"), zoom=1, webshot = "webshot2") # webshot = "webshot2"
...
ggsave(file=paste0(here::here(), '/replication_paper/political_analysis_draft/p_recall.png'),
       plot = p_recall ,
       width=5, height=3.0)
...
tiger <- image_read(here::here("replication_paper", "political_analysis_draft", "recall_cuban_and_crimea.png"))
tiger2 <- image_read(paste0(here::here(), '/replication_paper/political_analysis_draft/p_recall.png'))

combined <- image_composite(tiger, image_scale(tiger2, "x290"), offset = "+475+650")
image_write(combined, here::here("replication_paper", "political_analysis_draft", "recall_cuban_and_crimea_andcounts.png"))
...
ratio=.75
height=18
save_plot(file=paste0(here::here(), '/replication_paper/political_analysis_draft/p_196_icbe.png'),
...
ratio=.75
height=18
save_plot(file=paste0(here::here(), '/replication_paper/political_analysis_draft/p_471_icbe.png'),
...
ratio=1.5
height=18
save_plot(file=paste0(here::here(), '/replication_paper/political_analysis_draft/p_precision_combined.png'),
...
ggsave(file=paste0(here::here(), '/replication_paper/political_analysis_draft/p_semantic_embeddings.png'), plot = p_semantic_embeddings, width=12, height=8)
...
ggsave(file=paste0(here::here(), '/replication_paper/political_analysis_draft/p_dendro.png'), plot = p_dendro, width=12, height=10)
...
ggsave(file=paste0(here::here(), '/replication_paper/political_analysis_draft/p_semantic_embeddings_dendro.png'), plot = p_combined, width=12, height=10)
...
save_plot(file=paste0(here::here(),
                      '/replication_paper/political_analysis_draft/p_precision_icews.png'),
...
We thank the ICB Project and its directors and contributors for their foundational work and their help with this effort. We make special acknowledgment of Michael Brecher for helping found the ICB project in 1975, creating a resource that continues to spark new insights to this day.  We thank the many undergraduate coders for their patience and dedication. Thanks to the Center for Peace and Security Studies and its membership for comments. Special thanks to Rebecca Cordell, Philip Schrodt, Zachary Steinert-Threlkeld, and Zhanna Terechshenko for their generous feedback. Thank you to the cPASS research assistants that contributed to this project: Helen Chung, Daman Heer, Syeda ShahBano Ijaz, Anthony Limon, Erin Ling, Ari Michelson, Prithviraj Pahwa, Gianna Pedro, Tobias Stodiek, Yiyi 'Effie' Sun, Erin Werner, Lisa Yen, and Ruixuan Zhang.
