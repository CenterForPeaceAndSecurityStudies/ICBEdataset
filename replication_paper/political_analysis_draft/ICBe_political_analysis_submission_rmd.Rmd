...
nocite: |
  @fazalStateDeathPolitics2011, @ryanNationStatesEmpiresWars2021, @spruytSovereignStateIts1996, @haffarEmergentPeacemakersCataloguing2002, @kuznetsovTheoryPracticeParadiplomacy2014,  @bushDensityDeclineFounding2019, @mcclearyPrivateVoluntaryOrganizations2008, @olterIntergovernmentalOrganizationsIGOs2021, @benyehudaEthnicActorsInternational2006, @buenodemesquitaDomesticExplanationsInternational2012, @lacinaExplainingSeverityCivil2006, @lacinaMonitoringTrendsGlobal2005, @carafanoMeasuringMilitaryPower2014, @goertzMeasuringMilitaryAllocations1986, @mcnabbcochranMeasuringMilitaryEffectiveness2017, @gartzkeCrossDomainDeterrenceStrategy2019, @lanoszkaLandpowerAmericanCredibility2016, @lindsayPoliticsManyOther2020, @carterStrategyTerritorialConflict2010, @luptonReexaminingReputationResolve2018, @goldgeierPsychologyInternationalRelations2001, @mercerProspectTheoryPolitical2005, @steinEvaluatingWarOutcomes1980, @sullivanWarAimsWar2007, @ramsayInformationUncertaintyWar2017, @yarhi-miloEyeBeholderHow2013, @oneillInternationalNegotiationConceptual2018, @tragerDiplomacyWarPeace2016, @zartmanEscalationNegotiationInternational2005, @davisThreatsPromisesPursuit2000, @sechserMilitarizedCompellentThreats2011, @powellBargainingTheoryInternational2002, @goemansIntroducingArchigosDataset2009, @harknessEthnicArmyState2016, @jonesHitMissEffect2009, @matanockElectingPeaceCivil2017, @powellGlobalInstancesCoups2011, @chenowethIntroducingNonviolentAction2019, @eckOneSidedViolenceCivilians2007, @lafreeIntroducingGlobalTerrorism2007, @beardsleyMediationDilemma2011, @giblerMeasuringAlliancesCorrelates2004, @owsiakInternationalBorderAgreements2018, @leedsAllianceReliabilityTimes2003, @leedsDomesticPoliticalInstitutions1999, @demesquitaForeignAidPolicy2007, @yarhi-miloArmAllyPatron2016, @laiEffectsDifferentTypes2004, @allenUSGlobalMilitary2021, @fortnaPeaceTime2018, @minInterstateWarBattle2021, @levyCausesWar2011, @reiterHowWarsEnd2009, @frederickIssueCorrelatesWar2017, @henselChartingCourseConflict1996
...
lit_review_alt <- lit_review_pull %>% 
                  ...
                  mutate(Literature = paste0("",Literature %>% stringr::str_replace(";",",") ,"")) %>%
                  #mutate(Literature = paste0("  [",Literature %>% stringr::str_replace("; {0,}$","") ,"]")) %>%
