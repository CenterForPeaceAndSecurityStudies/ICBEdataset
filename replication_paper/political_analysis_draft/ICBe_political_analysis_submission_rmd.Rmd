...
litreview_ft_political_analysis <- lit_review_alt %>%
      ...
      flextable::bold(i = 1:k, j=2, bold = TRUE, part = "body") %>%
...
========================================
This article’s data, online appendix, replication material, and visualizations of every historical episode are available on the github repository [ICBEventData](https://urldefense.com/v3/__https://github.com/CenterForPeaceAndSecurityStudies/ICBEventData__;!!Mih3wA!WxDJtEczKfxGTh0S2Krunap8ReymFEL5iTWaSfOHeqlSdyfRx77zmjBSWO1OAm13$) and through the companion website www.crisisevents.org.
