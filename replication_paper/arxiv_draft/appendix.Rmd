...
temp_all %>% ungroup() %>% filter(crisno %in% c(1:60) )  %>% convert_to_ft() %>%
  save_as_image(path=here::here("replication_paper", "arxiv_draft", "crisis_text_counts_ft1.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(61:120) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "arxiv_draft", "crisis_text_counts_ft2.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(121:180) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "arxiv_draft", "crisis_text_counts_ft3.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(181:240) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "arxiv_draft", "crisis_text_counts_ft4.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(241:300) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "arxiv_draft", "crisis_text_counts_ft5.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(301:360) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "arxiv_draft", "crisis_text_counts_ft6.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(361:420) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "arxiv_draft", "crisis_text_counts_ft7.png"), zoom=1)

temp_all %>% ungroup() %>% filter(crisno %in% c(421:500) ) %>% convert_to_ft()  %>% 
  save_as_image(path=here::here("replication_paper", "arxiv_draft", "crisis_text_counts_ft8.png"), zoom=1)
...
if(fromscratch){
  ...
  ggplot2::ggsave(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_percent_chose_tag_by_concept.png'), 
...
if(fromscratch){
  ...
  ggplot2::ggsave(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_percent_chose_tag_by_confidence.png'), 
...
ft_cuba_recall %>% save_as_image(path=here::here("replication_paper", "arxiv_draft", "ft_cuba_recall.png"), zoom=1) # webshot = "webshot2"
...
ft_crimea_recall %>% save_as_image(path=here::here("replication_paper", "arxiv_draft", "ft_crimea_recall.png"), zoom=1) # webshot = "webshot2"
...
if(fromscratch){
  ...
  ft_crimea_precision_part1 %>% save_as_image(path=here::here("replication_paper", "arxiv_draft", "case_study_crimea_precision_part1.png"), zoom=1) # webshot = "webshot2"
  ...
  ft_crimea_precision_part2 %>% save_as_image(path=here::here("replication_paper", "arxiv_draft", "case_study_crimea_precision_part2.png"), zoom=1) # webshot = "webshot2"
...
ft_sample_precision_precision1 %>% save_as_image(path=here::here("replication_paper", "arxiv_draft", "ft_sample_precision_precision1.png"), zoom=1) # 
...
ft_sample_precision_precision2 %>% save_as_image(path=here::here("replication_paper", "arxiv_draft", "ft_sample_precision_precision2.png"), zoom=1) # 
...
ft_sample_precision_precision3 %>% save_as_image(path=here::here("replication_paper", "arxiv_draft", "ft_sample_precision_precision3.png"), zoom=1) # 
...
ft_sample_precision_precision4 %>% save_as_image(path=here::here("replication_paper", "arxiv_draft", "ft_sample_precision_precision4.png"), zoom=1) # 
...
icb_crisismaps <- function(thiscrisis=196, prune_rare=T){
    ...
    print(thiscrisis)
    save_icb_file <- paste0(here::here(), "/replication_paper/arxiv_draft/p_icb_metro_plot_",thiscrisis,".Rds")
...
mids_crisismaps <- function(thiscrisis=196, prune_rare=T){
  ...
  save_mids_file <- paste0(here::here(), "/replication_paper/arxiv_draft/p_mids_metro_plot_",thiscrisis,".Rds")
...
phoenix_barmaps <- function(thiscrisis=196, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/arxiv_draft/p_phoenix_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/arxiv_draft/p_phoenix_plot_lv0_",thiscrisis,".Rds")
...
terrier_barmaps <- function(thiscrisis=471, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/arxiv_draft/p_terrier_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/arxiv_draft/p_terrier_plot_lv0_",thiscrisis,".Rds")
...
icews_barmaps <- function(thiscrisis=471, topactor=F){
    ...
    print(thiscrisis)
    plot_title <- crisno_name_years %>% filter(crisno==thiscrisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
    save_file_penta <- paste0(here::here(), "/replication_paper/arxiv_draft/p_icews_plot_penta_",thiscrisis,".Rds")
    save_file_lv0 <- paste0(here::here(), "/replication_paper/arxiv_draft/p_icews_plot_lv0_",thiscrisis,".Rds")
...
## Dyadic ICB
save_file=paste0(here::here(), '/replication_paper/arxiv_draft/p_icb_metro_plot_196.Rds')
...
## MIDs
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/arxiv_draft/p_mids_metro_plot_196.Rds') 
p_metro_plot <- readRDS(save_file)
actor_colors <- p_metro_plot$actor_colors
...
#ggsave(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_mids_metro_plot_196.png'),
#       plot = p_metro_plot ,
#       width=12, height=14)
...
#ICBe  196
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/arxiv_draft/p_phoenix_plot_penta_196.Rds')
...
#ggsave(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_phoenix_metro_plot_196.png'),
#       plot = p_metro_plot ,
#       width=12, height=14)
...
save_plot(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_196_combined.png'),
...
if(fromscratch){
  p_phoenix_plot_lv0_196 <- readRDS(here::here("replication_paper", "arxiv_draft", "p_phoenix_plot_lv0_196.Rds"))
  save_plot(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_phoenix_plot_lv0_196.png'),
...
## MIDs
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/arxiv_draft/p_mids_metro_plot_471.Rds') 
p_metro_plot <- readRDS(save_file)
actor_colors <- p_metro_plot$actor_colors
subtitle="Dyadic Militarized Interstate Disputes (MIDs)"
caption=paste0("Source: CrisisEvents.org (Douglass et al. 2021)
...
#ICBe  196
library(ggplot2)
save_file=paste0(here::here(), '/replication_paper/arxiv_draft/p_phoenix_plot_penta_471.Rds')
subtitle="Phoenix Dyadic Events"
caption=paste0("Data: Cline Center Historical Phoenix Event Data (Althaus et al. 2017)
             ", p_metro_plot$labels$caption) #tag original to bottom
...
save_file=paste0(here::here(), '/replication_paper/arxiv_draft/p_terrier_plot_penta_471.Rds')
...
save_file=paste0(here::here(), '/replication_paper/arxiv_draft/p_icews_plot_penta_471.Rds')
...
save_plot(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_471_combined.png'),
...
if(fromscratch){
  p_phoenix_plot_lv0_471 <- readRDS(here::here("replication_paper", "arxiv_draft", "p_phoenix_plot_lv0_471.Rds"))
  save_plot(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_phoenix_plot_lv0_471.png'),
...
if(fromscratch){
  p_terrier_plot_lv0_471 <- readRDS(here::here("replication_paper", "arxiv_draft", "p_terrier_plot_lv0_471.Rds"))
  save_plot(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_terrier_plot_lv0_471.png'),
...
if(fromscratch){
  p_icews_plot_lv0_471 <- readRDS(here::here("replication_paper", "arxiv_draft", "p_icews_plot_lv0_471.Rds"))
  save_plot(file=paste0(here::here(), '/replication_paper/arxiv_draft/p_icews_plot_lv0_471.png'),
