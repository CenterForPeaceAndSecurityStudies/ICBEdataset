...
midip <- read_csv(paste0(here::here(), '/replication_paper/data/in/MIDIP_5.01.csv'))

midii <- read_csv(paste0(here::here(), '/replication_paper/data/in/MIDI_5.01.csv'))
...
icb2v14 <- read_csv(here::here(), "/replication_paper/data/in/icb2v14.csv")
...
ged211 <- read_csv(here::here(), "/replication_paper/data/in/ucdp_ged/ged211.csv")
...
CAMEO_eventcodes <- read_tsv(here::here(), "/replication_paper/data/in/CAMEO.eventcodes.txt", col_types='cc') %>% janitor::clean_names()
...
files <- list.files(path = paste0(here::here(), "/replication_paper/data/in/dataverse_files (1)/"), pattern = ".tab$", full.names = T)
...
icews_metro_plots <- function(crisis=426, topactor=F, exclude='', save_icews_file=NULL){
  ...
  plot_title <- crisno_name_years %>% filter(crisno==crisis) %>% mutate(title="Crisis #" %>% paste0(crisno, " ", crisname, " (", yrtrig, "-",yrterm,")")) %>% pull(title)
  if(is.null(savefile)){
    save_icews_file <- paste0(here::here(), "/replication_paper/figures/metro_plots/p_icews_metro_plot_",crisis,".Rds")
  }
...
a <- read_csv(paste0(here::here, '/replication_paper/data/in/phoenix/PhoenixBLN-NYT_1980-2018.csv', col_types = 'ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc'))
b  <- read_csv(paste0(here::here, '/replication_paper/data/in/phoenix/PhoenixBLN-SWB_1979-2019.csv', col_types = 'ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc'))
c  <- read_csv(paste0(here::here, '/replication_paper/data/in/phoenix/PhoenixFBIS_1995-2004.csv', col_types = 'ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc'))
d  <- read_csv(paste0(here::here, '/replication_paper/data/in/phoenix/PhoenixNYT_1945-2005.csv', col_types = 'ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc'))
e <- read_csv(paste0(here::here, '/replication_paper/data/in/phoenix/PhoenixWSJ_1945-2006.csv', col_types = 'ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc'))
...
files <- list.files(path = paste0(here::here(), "/replication_paper/data/in/largegeolocateddata/"), pattern = ".tsv$", full.names = T)
