...
files <- list.files(path = paste0(here::here(), "/replication_paper/data/ignore/icews_dataverse/"), full.names = T)
...
files <- list.files(path = paste0(here::here(), "/replication_paper/data/ignore/largegeolocateddata/"), pattern = ".tsv$", full.names = T)
