...
```{r}
if(terrier_fromscratch){
terrier_clean_temp <- terrier_clean_temp %>%
...
terrier_metro_plots <- function(crisis=426, topactor=F){
  ...
  date_start <- lubridate::as_date(paste0(icb_crises[icb_crises$crisno==crisis,]$yrtrig , "-", icb_crises[icb_crises$crisno==crisis,]$motrig, "-01"))
  date_end <- lubridate::as_date(paste0(icb_crises[icb_crises$crisno==crisis,]$yrterm , "-", icb_crises[icb_crises$crisno==crisis,]$moterm+1, "-01"))
