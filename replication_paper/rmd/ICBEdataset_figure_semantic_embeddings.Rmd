...
brewer_pal_info_df <- brewer.pal.info %>% dplyr::add_rownames( var = "rowname") %>% dplyr::arrange()
brewer_list <- list() 
...
posible_colors <- posible_colors[! posible_colors %in% c("#FFFFFF", "#FFFF99", "#E6F598", "#E0E0E0")] # drop white
...
value_means <- value_means %>% dplyr::mutate(label=ifelse(
