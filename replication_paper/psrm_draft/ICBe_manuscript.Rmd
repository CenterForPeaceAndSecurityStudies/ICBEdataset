...
[^8]: As the ICB narratives and ICBe are intended to explain the conflictual behavior in a political context, many of the missing events concern the economic components of conflict events (eg. nationalizing a foreign business). ICBe's limitation at this stage is its focus on international events that involve conflict (ICB crises), but even with this limitation in the information we trained on ICBe is more comprehensive than the existing datasets that *do* try to code the economic dimensions of these conflicts. Since expanding the ontology to broader international phenomenon is an easier problem to address than the over-inclusion of irrelevant information, we see this as promising for future implementation of our model.
