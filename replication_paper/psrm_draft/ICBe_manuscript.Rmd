...
Table 1 demonstrates that with the exception of large-scale CAMEO dictionary-based systems, our ontology improves upon the the existing state of the art quantitative datasets that ignore important information content about international interactions.[^5] In particular,
...
-   separating chess pieces from players (military vs civilian)
