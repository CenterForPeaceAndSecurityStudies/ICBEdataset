...
if(fromscratch & length(files_worker_saves)>0){
    ...
    if(fromscratch){
      icb_crisis_summaries <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_corpus/data/out/icb_corpus_V1.0_May_16_2022.Rds")
    ...
    icb_long_crisis_sentence_unique %>% saveRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_corpus/data/out/icb_long_crisis_sentence_unique.Rds")
    }
    icb_long_crisis_sentence_unique <- readRDS("/mnt/8tb_a/rwd_github_private/ICBEdataset/replication_corpus/data/out/icb_long_crisis_sentence_unique.Rds")
