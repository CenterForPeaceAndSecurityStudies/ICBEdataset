...
if(fromscratch & length(files_worker_saves)>0){
    ...
    saveRDS(icb_coder_crisis_sentence_event,
            file=paste0(here::here(),"/replication_data/temp/icb_coder_crisis_sentence_event.Rds"))
  }  else  {
    icb_coder_crisis_sentence_event <-
      readRDS(file=paste0(here::here(),"/replication_data/temp/icb_coder_crisis_sentence_event.Rds"))
}
