...
Iterate and visualize sentences until convinced the translation is right

```{r, eval=F}

codings_wide_agreed_labeled_sample_ft <- 
      codings_wide_agreed_pruned_labeled %>%
                ...
                flextable::bg( i = which( 1:nrow(codings_wide_agreed_pruned_labeled) %% 2 == 1)  , j=1:ncol(events_df), part = "body", bg = "#EFEFEF") %>%
                flextable::width(j = 1, width=0.3, unit = "in") %>%
                flextable::width(j = 2, width=3, unit = "in") %>%
                flextable::width(j = 3, width=3, unit = "in")

codings_wide_agreed_labeled_sample_ft  %>% saveRDS(paste0(here::here(), '/replication_paper/tables/codings_wide_agreed_labeled_sample_ft.Rds'))
codings_wide_agreed_labeled_sample_ft
...
saveRDS(codings_long, paste0(here::here(), "/replication_data/temp/codings_long.Rds")) 
saveRDS(codings_long, paste0(here::here(), "/replication_paper/data/in/codings_long.Rds")) 

saveRDS(codings_long_agreement, paste0(here::here(), "/replication_data/temp/codings_long_agreement.Rds")) 
saveRDS(codings_long_agreement, paste0(here::here(), "/replication_paper/data/in/codings_long_agreement.Rds")) 

saveRDS(codings_long_agreed, paste0(here::here(), "/replication_data/out/codings_long_agreed.Rds")) 
saveRDS(codings_long_agreed, paste0(here::here(), "/replication_paper/data/in/codings_long_agreed.Rds")) 

saveRDS(codings_wide_agreed_pruned_labeled, paste0(here::here(), "/replication_data/out/codings_wide_agreed.Rds")) 
saveRDS(codings_wide_agreed_pruned_labeled, paste0(here::here(), "/replication_paper/data/in/codings_wide_agreed.Rds")) 
